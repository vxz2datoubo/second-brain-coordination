...
class SceneGraph:
    ...
    def _validate_and_index(self) -> None:
        ...
        raw_actions: list[tuple[tuple[str, str], Mapping[str, Any]]] = []
        for scene in scenes:
            ...
            for raw_beat in beats:
                ...
                for raw_action in actions:
                    ...
                    raw_actions.append(((scene_id, beat_id), raw_action))
...
def synthetic_three_scene_manifest() -> dict[str, Any]:
    ...
    return {
        ...
        "scenes": [
            {"scene_id": "archive_gate", "beats": [
                {"beat_id": "arrival", "text": "Two adult archivists reach the rain-lit gate.", "recap": "At the archive gate.", "actions": [
                ...
                {"beat_id": "echo", "text": "A quiet voice names an old case number.", "recap": "A witness has spoken from inside.", "actions": [
            ...
            {"scene_id": "interior_archive", "beats": [
                {"beat_id": "threshold", "text": "The door opens a handspan; the witness asks for safety.", "recap": "At the archive threshold.", "actions": [
                ...
                {"beat_id": "accord", "text": "The group agrees to preserve the record until morning.", "recap": "A cautious accord is reached.", "actions": [
