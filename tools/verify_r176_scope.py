"""Fail closed when an R176 change leaves its authorized write surface."""
...
DEFAULT_BASE = "1502fb11f77cbe7b16f87ed6f0624a21cba303d8"
ALLOWED_PREFIXES = (
    "creative_runtime/",
    "tests/",
    "tools/",
