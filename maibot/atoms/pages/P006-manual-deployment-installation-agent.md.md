...
id: P006
type: source-page
title: "Agent 安装指南(测试中，不保证可用)"
source: "https://docs.mai-mai.org/manual/deployment/installation-agent.md"
snapshot: "2026-06-22"
...
## 来源
- 官方页面：[https://docs.mai-mai.org/manual/deployment/installation-agent.md](https://docs.mai-mai.org/manual/deployment/installation-agent.md)
