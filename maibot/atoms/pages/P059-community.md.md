...
type: source-page
title: "社区"
source: "https://docs.mai-mai.org/community.md"
snapshot: "2026-06-22"
...
## 来源
- 官方页面：[https://docs.mai-mai.org/community.md](https://docs.mai-mai.org/community.md)
...
- 使用清晰的标题描述问题
- 提供复现步骤和环境信息（操作系统、Python 版本、MaiBot 版本）
- 附上相关的日志输出
- 检查是否已有相同问题的 Issue
