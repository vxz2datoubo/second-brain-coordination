...
MUTATION_SPECS: tuple[MutationSpec, ...] = (
    ...
    MutationSpec("MUT-CANONICAL-TEST-NORMALIZATION", "src/e56_authority/provider.py", "normalized_test_result = _canonical_test_result(test_result)", "normalized_test_result = dict(test_result)", "test_provider_tools.ProviderTests.test_canonical_excludes_executor_command_details", "CE-CANONICAL-EXECUTOR-LEAK", "canonical bytes vary with an executor-specific command path"),
