"""CLI wrapper for dual Provider downloaded-evidence reconstruction."""
...
def main() -> int:
    ...
    parser.add_argument("--expected-tested-evidence-digest")
    parser.add_argument("--expected-receipt-evidence-digest")
    ...
    try:
        ...
        print(f"Provider evidence verification failed: {exc}", file=sys.stderr)
        return 1
    return 0
