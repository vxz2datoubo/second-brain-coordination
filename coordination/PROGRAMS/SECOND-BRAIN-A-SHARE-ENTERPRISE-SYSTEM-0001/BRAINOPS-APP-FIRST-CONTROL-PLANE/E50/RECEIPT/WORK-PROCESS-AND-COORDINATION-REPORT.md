...
Codex owned code, tests, selected source mapping and public-safe evidence.
GPT owns the remaining canonical-main post-run attestation. WorkBuddy and
other agents were not invoked. No accounts, credentials, market data or
execution surfaces were accessed.
