...
E50 preserved frozen E49 as selected source only. A real temporary Git graph
proves exit-status ancestry semantics, while a disposable clean clone proves
the documented verifier command rejects changed state and untrusted evidence.
