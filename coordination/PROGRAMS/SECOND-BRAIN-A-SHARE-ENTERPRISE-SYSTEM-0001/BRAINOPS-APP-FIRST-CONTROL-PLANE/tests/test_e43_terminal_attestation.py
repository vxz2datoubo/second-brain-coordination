...
class E43TerminalAttestationTests(unittest.TestCase):
    ...
    @staticmethod
    def _raw_terminal(holder: ClaimHolder, *, challenge_id: str = "challenge.e43.one", nonce: str = NONCE, terminal_at: str = "2026-08-02T12:05:00Z", status: str = "completed", started_at: str = "2026-08-02T12:04:00Z"):
    ...
    def _started_and_observed(self, root: Path):
        ...
        envelope = _bounded_transport_attestor("transport.e43").attest(challenge, self._raw_terminal(holder), "2026-08-02T12:05:01Z")
    ...
    def test_matching_durable_terminal_allows_positive_classification(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            reconciliation = TerminalExecutionReconciler.reconcile(observed, finalized.record, "2026-08-02T12:05:02Z")
