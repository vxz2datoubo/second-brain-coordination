...
def evaluate_capability(target: CapabilityTarget, observation: object | None) -> CapabilityPreflightDecision:
    ...
    return CapabilityPreflightDecision(target, observation.status, "trusted_capability_observed", observation)
...
def classify_execution(claim: DurableClaimRecord, receipt: object | None) -> ExecutionEvidenceAssessment:
    ...
    return ExecutionEvidenceAssessment(receipt.raw.evidence_type, claim.claim_id, receipt.raw.invocation_id, "trusted_invocation_receipt_complete")
