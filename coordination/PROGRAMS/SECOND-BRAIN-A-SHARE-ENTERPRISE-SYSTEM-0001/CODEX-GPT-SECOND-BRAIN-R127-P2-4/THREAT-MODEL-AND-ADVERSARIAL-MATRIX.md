...
Public output must expose only coarse provider state authorized by the caller, never provider exception payload, IDs, source metadata, hidden suggestion count or hidden endpoint reason.
