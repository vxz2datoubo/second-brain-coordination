...
EXPECTED_R6_AUTHORITY_ID = "R144-GPT-ARCHITECTURE-OWNER-MAINTENANCE-ADOPTION-R6-0001"
...
R6_TERMINAL_RECORD = {
    "authority_id": EXPECTED_R6_AUTHORITY_ID,
...
EXPECTED_TERMINAL_RECORDS: dict[str, dict[str, Any]] = {
    ...
    EXPECTED_R6_AUTHORITY_ID: R6_TERMINAL_RECORD,
}
