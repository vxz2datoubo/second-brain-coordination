...
| R195-A14 | TinyFish A-share-specific acquisition is proven | Plugin is connected, but no A-share-specific acceptance probe completed in this slice | PARTIAL | bounded official-announcement/browser probe with provenance |
