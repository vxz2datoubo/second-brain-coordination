...
module's namespace. R185 compute-lane hardening and the Issue #619 canonicalization-effect
isolation contracts are layered in the same namespace so there remains one public validator
authority and existing monkey-patch based trust tests keep working.
"""
...
exec(
    compile(
        _canonicalization_extension_path.read_text(encoding="utf-8"),
        str(_canonicalization_extension_path),
        "exec",
    ),
    globals(),
    globals(),
...
del _extension_path, _canonicalization_extension_path
