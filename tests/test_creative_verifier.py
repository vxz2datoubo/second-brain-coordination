...
class CreativeVerifierTests(unittest.TestCase):
    def test_verifier_produces_a_reproducible_offline_receipt(self) -> None:
        ...
        self.assertEqual(receipt["demonstration"]["drama_selection_schema"], "DramaticBeatSelection/v1")
        self.assertEqual(receipt["demonstration"]["drama_campaign_status"], "campaign_progression_verified")
        self.assertEqual(receipt["demonstration"]["drama_campaign_opposition_status"], "pressuring")
        self.assertEqual(receipt["demonstration"]["drama_coverage_percent"], 100)
